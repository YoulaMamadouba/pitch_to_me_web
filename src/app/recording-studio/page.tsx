...
import { ChevronLeft, Settings, Mic, Video, Square, Pause, RefreshCw, Search, Maximize2 } from 'lucide-react';
...
export default function RecordingStudio() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white flex flex-col">
      ...
      <main className="container mx-auto px-4 pt-20 pb-24 max-w-3xl flex-grow">
        {/* Recording Status */}
        {isRecording && (
          <div className="bg-red-900/30 border border-red-600 rounded-xl p-4 mb-6 animate-pulse">
            ...
            <div className="mt-3">
              <div className="text-sm mb-2">Session: Entraînement Pitch</div>
        ...
        {/* Camera Angles */}
        <div className="mb-6">
          <h2 className="text-lg font-semibold mb-3">Angles de caméra</h2>
        ...
        <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700 mb-4">
          <div className="flex justify-between items-center mb-3">
            <h2 className="text-lg font-semibold">Niveaux audio</h2>
