        ...
        >
          ...
          <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-2xl p-8 border border-gray-600 shadow-2xl">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300 text-sm">Continue your speaking journey</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mb-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-yellow-400 text-sm underline hover:text-yellow-300">
                  Forgot Password?
                </Link>
              </div>
            </form>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-yellow-400 to-yellow-500 text-black font-semibold py-3 rounded-xl mb-6 hover:from-yellow-300 hover:to-yellow-400 transition-all duration-300 shadow-lg shadow-yellow-400/25"
            >
              Sign In
            </button>
            ...
            <div className="grid grid-cols-3 gap-3 mb-6">
              <button className="bg-white text-gray-800 py-2.5 rounded-lg flex items-center justify-center hover:bg-gray-100 transition-colors">
              ...
              <button className="bg-blue-600 text-white py-2.5 rounded-lg flex items-center justify-center hover:bg-blue-700 transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </button>
              
              <button className="bg-black text-white py-2.5 rounded-lg flex items-center justify-center border border-gray-600 hover:bg-gray-900 transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center">
              <p className="text-gray-400 text-sm">
                ...
                <Link href="/signup" className="text-yellow-400 underline ml-1 hover:text-yellow-300">
                  Sign Up
                </Link>
              </p>
            </div>
