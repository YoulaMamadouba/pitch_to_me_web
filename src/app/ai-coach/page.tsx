...
export default function AICoachChat() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto">
          <AnimatePresence>
            {messages.map((message) => (
              ...
              >
                <div className={`max-w-[90%] md:max-w-[75%] w-full ${message.sender === 'user' ? 'bg-gradient-to-r from-yellow-500 to-yellow-400 text-gray-900' : 'bg-gray-800/70 backdrop-blur-sm border border-white/10'} rounded-2xl p-4 shadow-lg`}>
      ...
      {/* Input Area */}
      <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent pb-4 pt-16 px-4">
        <div className="max-w-2xl mx-auto">
          {showSuggestions && (
