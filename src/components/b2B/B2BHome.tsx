...
import { Play, Check, Star, Clock, Award, Building, Users, Zap, Plus } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-gray-800 to-gray-700 rounded-xl p-6">
        <h1 className="text-2xl font-bold text-white mb-2">Bienvenue sur votre dashboard B2B</h1>
        <p className="text-gray-300">Continuez votre apprentissage et développez vos compétences professionnelles</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm">Modules complétés</p>
        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm">Heures d'apprentissage</p>
      ...
      {/* Video Section */}
      <section className="rounded-xl overflow-hidden shadow-xl">
      ...
      >
        <h2 className="text-2xl font-bold text-white mb-1">Empower Your Sales Team</h2>
